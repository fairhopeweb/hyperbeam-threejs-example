...
async function main() {
  const Hyperbeam = (
	await eval(
	  `import("https://unpkg.com/@hyperbeam/web@latest/dist/index.js")`
	)
  ).default;
  const embedURL = "https://4w5rhqjkkux2w09ewbcx90zou.hyperbeam.com/OR5rHLy4TzuoQM5rtPLlPA?token=NIfLV2eIqw8SWXlJnusD6eI1zRxiYyazqRiwO_E4PiM"
